...
var Module = {
	...
	UE4_indexedDBVersion: 202311271026, // Bump this number to invalidate existing IDB storages in browsers.
};
...
//	}
	...
	function withIndexedDB(db) {
		...
		// ----------------------------------------
		// MAIN JS
		var mainJsDownload = fetchOrDownloadAndStore(db, Module.locateFile('https://rawcdn.githack.com/Ilyaz02335/GamePyrobyte/a67f0101d7a9e416440a1341c170bcc0401e0814/MyProject4-HTML5-Shipping.js'), 'blob').then(function(data) {
		...
		// ----------------------------------------
		// MORE JS
		var dataJsDownload = fetchOrDownloadAndStore(db, Module.locateFile('https://rawcdn.githack.com/Ilyaz02335/GamePyrobyte/bef71e6d33c466f69e49b68923999b36b9340546/MyProject4-HTML5-Shipping.data.js'));
		var utilityJsDownload = fetchOrDownloadAndStore(db, Module.locateFile('https://rawcdn.githack.com/Ilyaz02335/GamePyrobyte/bef71e6d33c466f69e49b68923999b36b9340546/Utility.js')).then(addScriptToDom);
		var dataDownload =
